    ...
    <section ref={sectionRef} className="px-6 py-24 md:py-32">
      <div className="mx-auto max-w-4xl">
        ...
        >
          ...
          <h2 className="relative mb-4 text-3xl font-bold text-background md:text-4xl">
            Ready to run your first vote?
          </h2>
          <p className="relative mb-8 text-lg text-background/70">
          ...
          <div className="relative flex flex-col items-center justify-center gap-4 sm:flex-row">
            <button className="cursor-pointer rounded-xl bg-background px-8 py-3.5 text-base font-bold text-primary transition-colors hover:bg-background/90">
              Get Started for Free
            </button>
            <button className="cursor-pointer rounded-xl border border-background/30 px-8 py-3.5 text-base font-medium text-background transition-colors hover:bg-background/10">
              Talk to Sales
            </button>
          </div>
        </div>
